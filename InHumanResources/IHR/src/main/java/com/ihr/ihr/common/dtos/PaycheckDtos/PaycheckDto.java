...
public class PaycheckDto {
    ...
    public PaycheckDto(Long id, Long paymentId, LocalDate date, Double basicSalary, Double bonusForSuccess, Integer numberOfShares, Integer cumulatedShares, Double salaryBeforeTaxes, Double tax, Double socialCharge, Double finalSalary) {
        this.id = id;
