...
<t:pageTemplate pageTitle="InHumanResources">
  <section class="hero text-center py-5" style="color: black;">
    <div class="container-fluid">
      <h1 class="display-4" style="background: linear-gradient(to right, #192a56, #55b8f6); -webkit-background-clip: text; -webkit-text-fill-color: transparent; font-weight: bold;">Welcome to InHumanResources!</h1>
